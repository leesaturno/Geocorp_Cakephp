		...
		<div class="box box-primary">
			<div class="box-header">
				...
				<div class="box-tools pull-right">
	                <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i> Edit'), array('action' => 'edit', $municipio['Municipio']['id']), array('class' => 'btn btn-primary', 'escape' => false)); ?>
	            </div>
			</div>
