    ...
    <div class="col-xs-12">
		...
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><?php  echo __('Municipio'); ?></h3>
				<div class="box-tools pull-right">
	                <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i> Editar'), array('action' => 'edit', $municipio['Municipio']['id']), array('class' => 'btn btn-primary', 'escape' => false)); ?>
	            </div>
			</div>
		...
		<td>
			<?php echo h($municipio['Municipio']['descripcion']); ?>
			&nbsp;
		</td>
		...
		<td>
			...
			<div class="box box-primary">
				...
				<?php if (!empty($municipio['Patient'])): ?>
					...
					<div class="box-body table-responsive">
						<table class="table table-bordered table-striped">
							...
							<tbody>
									<?php
										$i = 0;
										foreach ($municipio['Patient'] as $patient): ?>
								<tr>
