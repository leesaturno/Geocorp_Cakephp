    ...
    <div class="col-xs-12">
		...
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><?php  echo __('Comun'); ?></h3>
				<div class="box-tools pull-right">
	                <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i> Edit'), array('action' => 'edit', $comun['Comun']['id']), array('class' => 'btn btn-primary', 'escape' => false)); ?>
	            </div>
			</div>
		...
		<td>
			<?php echo h($comun['Comun']['id']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Descripci'); ?></strong></td>
		<td>
			<?php echo h($comun['Comun']['descripci']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Created'); ?></strong></td>
		<td>
			<?php echo h($comun['Comun']['created']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
		...
		<th class="text-center"><?php echo __('Modified'); ?></th>
							...
							<tbody>
									<?php
										$i = 0;
										foreach ($comun['Patient'] as $patient): ?>
		<tr>
