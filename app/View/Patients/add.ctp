    ...
    <div class="col-xs-12">
	 ...
	 <div class="col-md-4">
					<div class="form-group">
						<?php echo $this->Form->input('person_id', ['label' => 'Persona', 'class' => 'chosen-select form-control', 'empty'=> true, 'default'=> 'N/A']); ?>
					</div><!-- .form-group -->
					</div>

				<div class="col-md-4">
				   	<div class="form-group">
						<?php echo $this->Form->input('etnia_id', ['label' => 'Etnia','class' => 'chosen-select form-control', 'empty'=> true, 'default'=> 'N/A']); ?>
					</div><!-- .form-group -->
					</div>
			 ...
			 <div class="col-md-4">
				...
				<div class="col-md-4">
					<div class="form-group">
						<?php echo $this->Form->input('country_id', ['label' => 'País','class' => 'chosen-select form-control', 'empty'=> true, 'default'=> 'N/A' ]); ?>
					</div><!-- .form-group -->
					</div><!-- .form-group -->
				<div class="col-md-4">

					<div class="form-group">
						<?php echo $this->Form->input('municipio_id', ['label' => 'Municipio', 'class' => 'chosen-select form-control', 'empty'=> true, 'default'=> 'N/A' ]); ?>
					</div><!-- .form-group -->
						</div><!-- .form-group -->
			<div class="col-md-4">
					<div class="form-group">
						<?php echo $this->Form->input('parroquia_id', ['label' => 'Parroquia', 'class' => 'chosen-select form-control', 'empty'=> true, 'default'=> 'N/A' ]); ?>
					</div><!-- .form-group -->
					</div><!-- .form-group -->
			
				<div class="col-md-4">
					<div class="form-group">
						<?php echo $this->Form->input('type_blood_id', ['label' => 'Tipo de Sangre', 'class' => 'chosen-select form-control', 'empty'=> true, 'default'=> 'N/A' ]); ?>
					</div><!-- .form-group -->
					</div><!-- .form-group -->	
				<div class="col-md-4">
					<div class="form-group">
						<?php echo $this->Form->input('ocupacion_id', ['label' => 'Ocupación', 'class' => 'chosen-select form-control', 'empty'=> true, 'default'=> 'N/A' ]); ?>
					</div><!-- .form-group -->
					</div><!-- .form-group -->
