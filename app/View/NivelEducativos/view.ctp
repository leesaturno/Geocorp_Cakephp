    ...
    <div class="col-xs-12">
		...
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><?php  echo __('Nivel Educativo'); ?></h3>
				<div class="box-tools pull-right">
	                <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i> Edit'), array('action' => 'edit', $nivelEducativo['NivelEducativo']['id']), array('class' => 'btn btn-primary', 'escape' => false)); ?>
	            </div>
			</div>
		...
		<td>
			<?php echo h($nivelEducativo['NivelEducativo']['id']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Descripcion'); ?></strong></td>
		<td>
			<?php echo h($nivelEducativo['NivelEducativo']['descripcion']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Created'); ?></strong></td>
		<td>
			<?php echo h($nivelEducativo['NivelEducativo']['created']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Modified'); ?></strong></td>
		<td>
			<?php echo h($nivelEducativo['NivelEducativo']['modified']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
			...
			<div class="box box-primary">
				...
				<?php if (!empty($nivelEducativo['History'])): ?>
		...
		<th class="text-center"><?php echo __('Question Id'); ?></th>
							...
							<tbody>
									<?php
										$i = 0;
										foreach ($nivelEducativo['History'] as $history): ?>
		<tr>
